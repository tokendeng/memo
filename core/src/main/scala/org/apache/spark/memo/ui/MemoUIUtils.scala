...
/**
 * Created by dengchangchun on 2016/8/30.
 */
@SimilarAs(clazz = "UIUtils")
object MemoUIUtils extends Logging {
            ...
            <div class="span12">
              <h3 style="vertical-align: middle; display: inline-block;">
                <a style="text-decoration: none" href={prependBaseUri("/")}>
                  <img src={prependBaseUri("/static/memo-logo-77x50px-hd.jpg")} />
                  <span class="version"
                        style="margin-right: 15px;">{org.apache.spark.memo.MEMO_VERSION}</span>
                </a>
                {title}
              </h3>
            </div>
